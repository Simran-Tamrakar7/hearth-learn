...
Learning cabin at [hearth-learn.vercel.app](https://hearth-learn.vercel.app). Catalog content lives under `/content`. How to add, hide, or restore items is in `/docs`.
