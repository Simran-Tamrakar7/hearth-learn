/** Chapter body for /manuals/testing-types. Listing/status: ../_registry.ts */
  ...
  "chapters": [
    {
      ...
      "practical": {
        ...
        "scenario": "Finance reports employee net salaries look wrong after a code change. Unit tests for the tax function immediately pinpoint the broken slab logic — a developer used < instead of <= on the 10% slab boundary, taxing employees earning exactly NPR 500,000 at 20% instead of 10%.",
      ...
      "checklist": [
        "Understands unit test boundaries",
        "Written tests in JUnit, PyTest, or Jest",
        "Ran coverage reports"
      ],
      "practice": {
        "title": "Boundary test suite",
        "brief": "Write 5 unit tests verifying tax boundary calculations and edge cases."
      },
      "resources": [
        {
          "type": "doc",
    ...
    },
    {
      ...
      "practical": {
        ...
        "scenario": "Full flow: log in, read an employee's leave balance (12 days), submit a 3-day annual leave request, re-read the balance, check a manager notification exists, approve the request, and re-check the balance stays consistent.",
      ...
      "checklist": [
        "Verified multi-endpoint API flows",
        "Implemented session auth caching",
        "Generated HTML integration reports"
      ],
      "practice": {
        "title": "Auth-to-checkout integration chain",
        "brief": "Create a 4-step chained request suite passing tokens and verifying database state."
      },
      "resources": [
        {
          "type": "doc",
        ...
        },
        {
          ...
          "url": "https://selenium.dev/documentation/",
          "lang": "EN",
          "free": true
        }
      ],
    ...
    },
    {
      ...
      "practical": {
        ...
        "scenario": "Full payroll cycle: log in as Payroll Admin, select the pay period, confirm all 47 active employees appear, process payroll, wait for async completion, verify one employee's gross/tax/net figures, generate payslips, then log in as that employee and check the payslip is visible.",
      ...
      "checklist": [
        "Covered complete end-to-end user journeys",
        "Configured headless CI pipeline",
        "Implemented failure trace capture"
      ],
      "practice": {
        "title": "Full user checkout & receipt journey",
        "brief": "Automate complete multi-page flow with assertions on confirmation invoice."
      },
      "resources": [
        {
          "type": "doc",
    ...
    },
    {
      ...
      "practical": {
        ...
        "scenario": "An HR Director with 15 years of experience applies for 3 days of casual leave for an employee who only has 2 remaining. Every automated test passed because test data always had sufficient balance — nobody tested this real-world boundary.",
      ...
      "checklist": [
        "Defined UAT entry and exit criteria",
        "Conducted stakeholder test sessions",
        "Achieved zero blocker formal sign-off"
      ],
      "practice": {
        "title": "UAT Sign-off package",
        "brief": "Draft a complete UAT sign-off memo including test matrix, triage list, and stakeholder signature block."
      },
      "resources": [
        {
          "type": "tool",
    ...
    },
    {
      ...
      "checklist": [
        "Documented test cases with clear preconditions",
        "Executed manual steps with bug evidence",
        "Verified fixes on staging build"
      ],
      "practice": {
        "title": "Exploratory testing session",
        "brief": "Conduct a 20-minute timeboxed exploratory session on the HRMS onboarding flow."
      },
      "resources": [
        {
          "type": "guide",
          "name": "Ministry of Testing — Exploratory Testing",
    ...
    },
    {
      ...
      "checklist": [
        "Authored automated UI regression suites",
        "Enabled auto-waiting assertions",
        "Configured CI pipeline triggers with video/trace artifacts"
      ],
      "practice": {
        "title": "CI Regression pipeline",
        "brief": "Set up a GitHub Actions workflow that executes Cypress/Playwright on every PR to main."
      },
      "resources": [
        {
          "type": "tool",
    ...
    },
    {
      ...
      "checklist": [
        "Verified all positive requirement paths",
        "Asserted negative input error messages",
        "Automated boundary checks in functional suite"
      ],
      "practice": {
        "title": "Business logic test suite",
        "brief": "Author a 5-test functional suite covering employee salary calculation rules."
      },
      "resources": [
        {
          "type": "tool",
          "name": "BugBug No-Code Testing",
          "url": "https://bugbug.io",
          "lang": "EN",
          "free": true
        }
    ...
    },
    {
      ...
      "checklist": [
        "Created fast-failing smoke test suite",
        "Automated trigger on post-deployment webhook",
        "Established instant failure notification alerts"
      ],
      "practice": {
        "title": "Smoke test gatekeeper",
        "brief": "Design a post-deploy smoke gate that halts bad releases in under 90 seconds."
      },
      "resources": [
        {
          "type": "guide",
          "name": "Google Testing Blog — Flaky Tests & Smoke Runs",
    ...
    },
    {
      ...
      "checklist": [
        "Identified exact touched scope",
        "Verified fix for root defect",
        "Confirmed zero regression in adjacent inputs"
      ],
      "practice": {
        "title": "Sanity verification plan",
        "brief": "Create a 5-point sanity checklist for a date-picker bug fix."
      },
      "resources": [
        {
          "type": "guide",
          "name": "Ministry of Testing — Sanity vs Smoke Testing",
    ...
    },
    {
      ...
      "checklist": [
        "Tagged tests with domain markers",
        "Automated parallel CI execution",
        "Configured failure artifact retention"
      ],
      "practice": {
        "title": "100-test regression framework",
        "brief": "Architect a fast, parallelized regression suite with retry mechanisms."
      },
      "resources": [
        {
          "type": "guide",
          "name": "Martin Fowler — Regression Testing Strategies",
    ...
    },
    {
      ...
      "checklist": [
        "Verified required field presence",
        "Asserted strict primitive types",
        "Validated error envelope structure"
      ],
      "practice": {
        "title": "API contract test suite",
        "brief": "Build a comprehensive Postman test suite validating API interface contracts."
      },
      "resources": [
        {
          "type": "tool",
          "name": "Postman Schema Testing",
          "url": "https://postman.com",
          "lang": "EN",
          "free": true
        }
    ...
    },
    {
      ...
      "checklist": [
        "Installed user behavior tracking snippet",
        "Captured 50+ real interaction sessions",
        "Resolved top drop-off UX friction points"
      ],
      "practice": {
        "title": "Usability audit & friction report",
        "brief": "Conduct a heatmap analysis and write a 3-point UX improvement plan."
      },
      "resources": [
        {
          "type": "tool",
          "name": "Hotjar Official Documentation",
          "url": "https://hotjar.com",
          "lang": "EN",
          "free": true
        },
        {
          "type": "guide",
          "name": "Nielsen Norman Group — Usability 101",
    ...
    },
    {
      ...
      "checklist": [
        "Verified LCP under 2.5s",
        "Optimized render-blocking assets",
        "Configured automated performance monitoring"
      ],
      "practice": {
        "title": "Core Web Vitals optimization plan",
        "brief": "Audit a slow landing page and deliver an LCP reduction strategy."
      },
      "resources": [
        {
          "type": "tool",
        ...
        {
          "type": "guide",
          "name": "web.dev — Core Web Vitals Guide",
    ...
    },
    {
      ...
      "checklist": [
        "Defined peak concurrent user volume",
        "Configured automated SLA failure thresholds",
        "Monitored backend database connection pools"
      ],
      "practice": {
        "title": "300-user load simulation",
        "brief": "Create an automated load test validating peak payroll login traffic."
      },
      "resources": [
        {
          "type": "tool",
          "name": "k6 Official Documentation",
        ...
        {
          "type": "tool",
          "name": "Apache JMeter Official Site",
          "url": "https://jmeter.apache.org",
          "lang": "EN",
          "free": true
        }
    ...
    },
    {
      ...
      "checklist": [
        "Identified absolute breaking concurrency point",
        "Confirmed absence of permanent data corruption",
        "Validated auto-recovery under 30 seconds"
      ],
      "practice": {
        "title": "Stress test & breaking point audit",
        "brief": "Discover the exact concurrency ceiling of an authentication API."
      },
      "resources": [
        {
          "type": "guide",
          "name": "AWS Well-Architected — Reliability & Stress Testing",
    ...
    },
    {
      ...
      "checklist": [
        "Constructed multi-node load test matrix",
        "Plotted throughput scaling curve",
        "Isolated architectural bottleneck layer"
      ],
      "practice": {
        "title": "Horizontal scaling efficiency report",
        "brief": "Model and test linear scaling capacity across a load-balanced cluster."
      },
      "resources": [
        {
          "type": "guide",
          "name": "Cloudflare — Understanding Horizontal vs Vertical Scalability",
          "url": "https://www.cloudflare.com/learning/performance/what-is-scalability/",
          "lang": "EN",
          "free": true
        }
      ],
    ...
    },
    {
      ...
      "checklist": [
        "Generated realistic synthetic test dataset",
        "Executed EXPLAIN ANALYZE on top 5 critical queries",
        "Added necessary indexes to maintain sub-100ms response times"
      ],
      "practice": {
        "title": "500,000-row volume query optimization",
        "brief": "Benchmark search endpoints under high-volume database conditions and optimize indexing."
      },
      "resources": [
        {
          "type": "tool",
          "name": "Faker Python Documentation",
          "url": "https://faker.readthedocs.io",
          "lang": "EN",
          "free": true
        },
    ...
    },
    {
      ...
      "checklist": [
        "Configured automated dependency CVE scanner",
        "Executed OWASP ZAP active scan against authenticated endpoints",
        "Verified strict object-level authorization controls"
      ],
      "practice": {
        "title": "OWASP Top 10 vulnerability assessment",
        "brief": "Conduct a penetration testing pass and audit authorization policies."
      },
      "resources": [
        {
          "type": "tool",
          "name": "OWASP ZAP Official Site",
          "url": "https://www.zaproxy.org",
          "lang": "EN",
          "free": true
        },
    ...
    },
    {
      ...
      "checklist": [
        "Verified mobile breakpoints (375px, 768px, 1024px)",
        "Tested on real iOS Safari and Android Chrome devices",
        "Confirmed touch target usability on mobile inputs"
      ],
      "practice": {
        "title": "Responsive & cross-browser audit",
        "brief": "Audit layout and interaction fidelity across mobile, tablet, and desktop viewports."
      },
      "resources": [
        {
          "type": "tool",
    ...
    },
    {
      ...
      "checklist": [
        "Completed 24h+ soak test under steady load",
        "Verified flat memory and CPU resource utilization",
        "Configured 60-second automated uptime health checks"
      ],
      "practice": {
        "title": "72-hour soak test & SLA monitoring plan",
        "brief": "Plan and execute an extended soak test to verify zero memory leaks over long durations."
      },
      "resources": [
        {
          "type": "tool",
    ...
    },
    {
      ...
      "practical": {
        "app": "HRMS Leave Request Form",
        "scenario": "The leave request form is scanned with axe DevTools, then manually tested using keyboard-only navigation.",
      ...
      "checklist": [
        "Achieved 0 Critical/Serious axe DevTools violations",
        "Verified visible keyboard focus indicators on all interactive elements",
        "Confirmed 4.5:1 minimum text contrast ratio"
      ],
      "practice": {
        "title": "WCAG 2.1 AA accessibility audit",
        "brief": "Audit form inputs, datepickers, and modal dialogues for complete screen-reader accessibility."
      },
      "resources": [
        {
          "type": "tool",
    ...
    },
    {
      ...
      "checklist": [
        "Defined explicit timebox and scope charter",
        "Explored interruption and back-navigation behaviors",
        "Logged novel edge-case bugs into automated regression suite"
      ],
      "practice": {
        "title": "Time-boxed exploratory charter",
        "brief": "Plan and execute a 60-minute unscripted exploratory bug hunt targeting checkout workflows."
      },
      "resources": [
        {
          "type": "guide",
          "name": "James Bach — Exploratory Testing Dynamics",
        ...
        {
          "type": "guide",
          "name": "Elisabeth Hendrickson — Explore It!",
    ...
    },
    {
      ...
      "checklist": [
        "Verified zero text truncation on longest locale strings",
        "Confirmed correct currency and date formatting rules",
        "Validated RTL layout mirroring for Arabic/Hebrew"
      ],
      "practice": {
        "title": "i18n & l10n compliance checklist",
        "brief": "Audit multi-currency, date-picker, and layout expansion in an internationalized application."
      },
      "resources": [
        {
          "type": "guide",
          "name": "MDN — Localization & Internationalization Guide",
          "url": "https://developer.mozilla.org/en-US/docs/Mozilla/Localization",
          "lang": "EN",
          "free": true
        },
    ...
    },
    {
      ...
      "checklist": [
        "Verified 100% database transaction rollback on mid-operation crashes",
        "Tested automatic process recovery within SLA threshold",
        "Validated idempotency tokens on retried client requests"
      ],
      "practice": {
        "title": "Disaster recovery and idempotency audit",
        "brief": "Model unexpected system failure during financial transactions and verify data consistency."
      },
      "resources": [
        {
          "type": "guide",
    ...
    },
    {
      ...
      "practical": {
        ...
        "scenario": "A tester checks that submitting a leave request for more days than an employee has remaining is correctly rejected, based only on the stated business rule (\"cannot request more leave than available balance\") — with no knowledge of how the balance is calculated internally.",
      ...
      "checklist": [
        "Defined input equivalence classes and boundary values",
        "Executed black box tests without implementation bias",
        "Automated high-value user paths with Selenium/Playwright"
      ],
      "practice": {
        "title": "Black box boundary value test plan",
        "brief": "Design an equivalence partitioning and boundary value test plan for user checkout."
      },
      "resources": [
        {
          "type": "guide",
          "name": "ISTQB — Black Box Testing Techniques",
        ...
        {
          "type": "tool",
          "name": "Selenium HQ Documentation",
          "url": "https://www.selenium.dev",
          "lang": "EN",
          "free": true
        }
    ...
    },
    {
      ...
      "checklist": [
        "Instrumented branch coverage reporting in CI/CD",
        "Eliminated uncovered conditional execution paths in business logic",
        "Enforced automated coverage quality gate"
      ],
      "practice": {
        "title": "White box branch coverage optimization",
        "brief": "Analyze uncovered execution paths in calculation modules and achieve >90% branch coverage."
      },
      "resources": [
        {
          "type": "tool",
    ...
    },
    {
      ...
      "checklist": [
        "Mapped test cases to schema constraints and unique indexes",
        "Validated graceful application-layer error handling for DB violations",
        "Tested API contracts with boundary-violating payloads"
      ],
      "practice": {
        "title": "Gray box API constraint test plan",
        "brief": "Design an API test suite targeting database uniqueness and foreign key integrity constraints."
      },
      "resources": [
        {
          "type": "guide",
          "name": "Postman — Contract Testing Best Practices",
        ...
        {
          "type": "guide",
          "name": "OWASP — Testing for Schema Validation",
          "url": "https://owasp.org",
          "lang": "EN",
          "free": true
        }
    ...
    },
    {
      ...
      "practical": {
        "app": "HRMS Login Page",
        "scenario": "A new team member, unfamiliar with the \"intended\" login flow, tries pasting an email address with trailing whitespace copied from an email signature.",
      ...
      "checklist": [
        "Tested irregular real-world user inputs (whitespace, rapid clicks, aborts)",
        "Successfully reproduced observed anomalies",
        "Added automated regression tests for confirmed defects"
      ],
      "practice": {
        "title": "Ad-hoc bug reproduction to regression workflow",
        "brief": "Convert an unstructured ad-hoc bug discovery into a reproducible automated test script."
      },
      "resources": [
        {
          "type": "guide",
          "name": "Guru99 — Ad-hoc Testing Guide",
        ...
        {
          "type": "guide",
          "name": "Ministry of Testing — Unstructured QA Insights",
          "url": "https://www.ministryoftesting.com",
          "lang": "EN",
          "free": true
        }
    ...
    },
    {
      ...
      "checklist": [
        "Verified 0 blocker defects across core business journeys",
        "Conducted cross-departmental testing with non-engineering staff",
        "Achieved official Go / No-Go signoff for public beta"
      ],
      "practice": {
        "title": "Alpha test plan & persona charter",
        "brief": "Create an internal alpha test plan covering 5 multi-step customer workflows."
      },
      "resources": [
        {
          "type": "guide",
          "name": "Atlassian — Alpha vs Beta Testing Strategy",
        ...
        {
          "type": "guide",
          "name": "ProductPlan — Managing Alpha Programs",
    ...
    },
    {
      ...
      "practical": {
        ...
        "scenario": "Before general release, the HRMS payroll module is piloted with one real client company (40 employees) for a full pay cycle.",
      ...
      "checklist": [
        "Configured feedback channels and automated crash reporting",
        "Monitored crash-free rate (>99.5% goal)",
        "Synthesized usability and performance feedback into sprint backlog"
      ],
      "practice": {
        "title": "Beta cohort rollout strategy",
        "brief": "Design a 3-tier staged beta rollout for iOS and Android mobile clients."
      },
      "resources": [
        {
          "type": "tool",
          "name": "Apple TestFlight Guide",
          "url": "https://developer.apple.com/testflight",
          "lang": "EN",
          "free": true
        },
        {
          "type": "tool",
          "name": "Google Play Console Testing Tracks",
          "url": "https://play.google.com/console",
          "lang": "EN",
          "free": true
        }
    ...
    },
    {
      ...
      "checklist": [
        "Retested exact historical reproduction sequence",
        "Verified across all reported platform/browser variations",
        "Attached video proof to defect tracker before marking closed"
      ],
      "practice": {
        "title": "Bug retesting & signoff checklist",
        "brief": "Document verification steps and cross-browser matrices for high-severity defect resolution."
      },
      "resources": [
        {
          "type": "guide",
          "name": "Ministry of Testing — Retesting vs Regression Testing",
          "url": "https://www.ministryoftesting.com",
          "lang": "EN",
          "free": true
        },
        {
          "type": "guide",
          "name": "ISTQB — Confirmation Testing Guidelines",
          "url": "https://www.istqb.org",
          "lang": "EN",
          "free": true
        }
    ...
    },
    {
      ...
      "practical": {
        ...
        "scenario": "Mutation testing is run specifically against the deductLeaveBalance() function, which already has 90% line coverage.",
      ...
      "checklist": [
        "Configured Stryker for business-critical algorithms",
        "Eliminated surviving mutants by adding precise boundary assertions",
        "Achieved >80% mutation score on audited modules"
      ],
      "practice": {
        "title": "Mutation test audit & mutant elimination",
        "brief": "Run Stryker on a financial calculation function and eliminate all surviving mutants."
      },
      "resources": [
        {
          "type": "tool",
          "name": "Stryker Mutator Official Site",
          "url": "https://stryker-mutator.io",
          "lang": "EN",
          "free": true
        },
        {
          "type": "guide",
          "name": "Mutation Testing Best Practices",
    ...
    },
    {
      ...
      "checklist": [
        "Defined single primary metric and measurable hypothesis",
        "Verified equal traffic allocation and hashing consistency",
        "Confirmed statistical significance (>95% confidence) before rollout"
      ],
      "practice": {
        "title": "A/B experimentation setup & hypothesis design",
        "brief": "Design an A/B test comparing single-page checkout against multi-step checkout."
      },
      "resources": [
        {
          "type": "tool",
          "name": "GrowthBook Documentation",
        ...
        {
          "type": "guide",
          "name": "Experimentation Works — Stefan Thomke",
          "url": "https://hbr.org/2020/02/the-surprising-power-of-online-experiments",
          "lang": "EN",
          "free": true
        }
      ],
    ...
    },
    {
      ...
      "checklist": [
        "Verified HTTP status codes for valid and invalid payloads",
        "Validated JSON schema types and required properties",
        "Automated collection execution in CI/CD pipeline"
      ],
      "practice": {
        "title": "API contract test collection",
        "brief": "Build a Postman/Newman collection with 10 assertions for authentication and CRUD endpoints."
      },
      "resources": [
        {
          "type": "tool",
    ...
    },
    {
      ...
      "checklist": [
        "Verified 0 orphaned foreign key references",
        "Audited not-null and uniqueness constraints with boundary injections",
        "Tested transaction rollback on unhandled mid-stream errors"
      ],
      "practice": {
        "title": "Database schema and constraint audit script",
        "brief": "Write an automated SQL audit script testing foreign key integrity and orphaned rows."
      },
      "resources": [
        {
          "type": "tool",
          "name": "DBeaver Community Download",
          "url": "https://dbeaver.io",
          "lang": "EN",
          "free": true
        },
        {
          "type": "guide",
          "name": "PostgreSQL Data Integrity Documentation",
    ...
    },
    {
      ...
      "practical": {
        ...
        "scenario": "An E2E test walks through the entire real journey: log in as an employee, navigate to the leave request form, fill it out, submit, log in as their manager, approve it, and confirm the leave balance updates correctly.",
      ...
      "checklist": [
        "Tested complete journey across UI, API, Cache, and Database layers",
        "Validated UI state cache invalidation upon external status mutations",
        "Integrated HTML trace artifact capture on test failures in CI"
      ],
      "practice": {
        "title": "End-to-end user transaction test spec",
        "brief": "Write a full Playwright E2E test verifying a multi-step user onboarding and approval journey."
      },
      "resources": [
        {
          "type": "tool",
    ...
    },
    {
      ...
      "checklist": [
        "Verified top 4 browser engines (Chrome, Firefox, Safari, Edge)",
        "Audited visual layout stability on Safari WebKit engine",
        "Automated parallel matrix execution in pre-release CI pipeline"
      ],
      "practice": {
        "title": "Cross-browser compatibility test matrix",
        "brief": "Set up a Playwright configuration targeting Chrome, Firefox, and WebKit on LambdaTest."
      },
      "resources": [
        {
          "type": "tool",
          "name": "LambdaTest Platform",
          "url": "https://lambdatest.com",
          "lang": "EN",
          "free": true
        },
    ...
    },
    {
      ...
      "practical": {
        ...
        "scenario": "A mobile-specific test deliberately backgrounds the app midway through filling out a leave request form, then returns to it after two minutes.",
      ...
      "checklist": [
        "Tested background and foreground lifecycle state persistence",
        "Verified touch target sizes (>48x48px) and multi-touch gestures",
        "Audited offline and low-bandwidth degradation behaviors"
      ],
      "practice": {
        "title": "Mobile app interruption automation spec",
        "brief": "Write an Appium test simulating app backgrounding and phone call interruptions."
      },
      "resources": [
        {
          "type": "tool",
          "name": "Appium Official Documentation",
        ...
        {
          "type": "guide",
          "name": "Mobile Testing Heuristics (I SLICED DICE)",
          "url": "https://kallithea-test.com/mobile-testing-heuristics",
          "lang": "EN",
          "free": true
        }
      ],
    ...
    },
    {
      ...
      "practical": {
        ...
        "scenario": "The HRMS desktop client is tested updating from version 2.3 to 2.4 on a machine with existing saved data and settings.",
      ...
      "checklist": [
        "Verified clean install on unprovisioned vanilla OS",
        "Confirmed user settings and local database survival after upgrade",
        "Audited complete file and registry cleanup upon uninstallation"
      ],
      "practice": {
        "title": "Installation and upgrade test plan",
        "brief": "Design an installation test matrix covering clean installs, upgrades, and interrupted setups."
      },
      "resources": [
        {
          "type": "guide",
          "name": "Installation Testing Guide",
          "url": "https://www.guru99.com/installation-testing.html",
          "lang": "EN",
          "free": true
        }
      ],
    ...
    },
    {
      ...
      "checklist": [
        "Verified authorization barriers across distinct user tenant boundaries",
        "Probed IDOR/BOLA across all numeric resource identifiers",
        "Audited web server configurations with Nikto infrastructure scanning"
      ],
      "practice": {
        "title": "Penetration testing proof of concept report",
        "brief": "Document an IDOR vulnerability reproduction with remediation patch guidance."
      },
      "resources": [
        {
          "type": "tool",
        ...
        {
          "type": "tool",
          "name": "Nikto Scanner GitHub Repository",
          "url": "https://github.com/sullo/nikto",
          "lang": "EN",
          "free": true
        }
    ...
    },
    {
      ...
      "practical": {
        ...
        "scenario": "A Screaming Frog crawl of the company's public careers section (linked from the HRMS) turns up a batch of broken internal links.",
      ...
      "checklist": [
        "Verified sitemap.xml validity in Google Search Console",
        "Confirmed zero broken internal links (4xx) across public pages",
        "Audited meta titles, descriptions, and OpenGraph social tags"
      ],
      "practice": {
        "title": "Site health crawl & broken link remediation",
        "brief": "Run Screaming Frog on a public portal and eliminate all 4xx/3xx redirect chains."
      },
      "resources": [
        {
          "type": "tool",
        ...
        {
          "type": "tool",
          "name": "Screaming Frog SEO Spider Guide",
    ...
    },
    {
      ...
      "checklist": [
        "Configured multi-location uptime checks on primary APIs",
        "Verified on-call alerting channel integration (Slack/PagerDuty)",
        "Enabled SSL certificate expiration alerts at 30-day thresholds"
      ],
      "practice": {
        "title": "Uptime monitoring and status page setup",
        "brief": "Set up an UptimeRobot dashboard monitoring 5 critical endpoints with a public status page."
      },
      "resources": [
        {
          "type": "tool",
          "name": "UptimeRobot Documentation",
          "url": "https://uptimerobot.com/help",
          "lang": "EN",
          "free": true
        },
        {
          "type": "tool",
          "name": "StatusCake Help Center",
          "url": "https://statuscake.com/help",
          "lang": "EN",
          "free": true
        }
      ],
    ...
    },
    {
      ...
      "practical": {
        ...
        "scenario": "The HRMS's bulk employee-import feature (CSV upload) is fuzz-tested with ZAP's fuzzer, feeding malformed and oversized field values into the upload parameter.",
      ...
      "checklist": [
        "Identified all untrusted data parsing interfaces (CSV, PDF, JSON)",
        "Audited input length limits and regex ReDoS vulnerabilities",
        "Eliminated unhandled 500 error responses during fuzzing runs"
      ],
      "practice": {
        "title": "API parameter fuzzing with OWASP ZAP",
        "brief": "Fuzz a user profile update API with 5,000 malformed unicode and boundary strings."
      },
      "resources": [
        {
          "type": "tool",
          "name": "AFL GitHub Repository",
          "url": "https://github.com/google/AFL",
          "lang": "EN",
          "free": true
        },
    ...
    },
    {
      ...
      "checklist": [
        "Scheduled weekly automated vulnerability scans in staging",
        "Triaged all Critical and High CVE findings with vendor patches",
        "Audited security headers (CSP, HSTS, X-Content-Type-Options)"
      ],
      "practice": {
        "title": "Automated DAST scan pipeline integration",
        "brief": "Set up a GitHub Actions workflow running OWASP ZAP baseline scan on PRs."
      },
      "resources": [
        {
          "type": "tool",
          "name": "Tenable Nessus Community",
          "url": "https://www.tenable.com/products/nessus",
          "lang": "EN",
          "free": true
        },
    ...
    },
    {
      ...
      "practical": {
        ...
        "scenario": "A SonarQube scan flags the calculateRemainingLeave() function for a code smell: deeply nested conditional logic that's hard to read and maintain.",
      ...
      "checklist": [
        "Configured strict linter rules in editor and pre-commit hook",
        "Enforced Quality Gate blocking PRs on new bugs or security flaws",
        "Eliminated code duplication and reduced cognitive complexity"
      ],
      "practice": {
        "title": "SonarQube quality gate and ESLint setup",
        "brief": "Configure a strict TypeScript ESLint config and SonarQube quality gate for a project."
      },
      "resources": [
        {
          "type": "tool",
          "name": "ESLint Official Documentation",
    ...
    },
    {
      ...
      "checklist": [
        "Verified live runtime execution across valid and invalid inputs",
        "Audited state transitions on UI, database, and cache layers",
        "Paired dynamic execution passes with prior static analysis checks"
      ],
      "practice": {
        "title": "Dynamic test suite implementation",
        "brief": "Implement a suite of Playwright dynamic tests asserting 0-day, negative, and max leave submissions."
      },
      "resources": [
        {
          "type": "tool",
          "name": "Playwright Test Guide",
        ...
        {
          "type": "guide",
          "name": "Dynamic Testing Methodology",
          "url": "https://www.guru99.com/dynamic-testing.html",
          "lang": "EN",
          "free": true
        }
      ],
    ...
    },
    {
      ...
      "checklist": [
        "Verified all interactive states (hover, focus, disabled, active)",
        "Audited color contrast ratios against WCAG 2.1 AA (>= 4.5:1)",
        "Automated modal, dropdown, and tooltip visibility assertions"
      ],
      "practice": {
        "title": "GUI component interaction and visual test",
        "brief": "Write automated tests checking form inputs, select dropdowns, and modal dialogs."
      },
      "resources": [
        {
          "type": "tool",
          "name": "Applitools Official Tutorial",
        ...
        {
          "type": "guide",
          "name": "W3C WAI-ARIA Authoring Practices",
    ...
    },
    {
      ...
      "checklist": [
        "Captured reference screenshots across mobile, tablet, and desktop viewports",
        "Enforced visual regression gate in pull request CI workflows",
        "Containerized test execution in Docker for consistent font rendering"
      ],
      "practice": {
        "title": "Visual regression test suite configuration",
        "brief": "Set up BackstopJS for a design system component library across 3 breakpoints."
      },
      "resources": [
        {
          "type": "tool",
        ...
        {
          "type": "tool",
          "name": "BackstopJS GitHub Repository",
          "url": "https://github.com/garris/BackstopJS",
          "lang": "EN",
          "free": true
        }
    ...
    },
    {
      ...
      "checklist": [
        "Identified invalid permutations for every required field",
        "Verified user-facing error message clarity and formatting",
        "Confirmed zero database state mutations on rejected requests"
      ],
      "practice": {
        "title": "Negative test suite design for user registration",
        "brief": "Design 15 negative test cases targeting invalid emails, weak passwords, and duplicate user records."
      },
      "resources": [
        {
          "type": "guide",
    ...
    },
    {
      ...
      "checklist": [
        "Verified all mandatory and optional fields with valid inputs",
        "Audited persistent state changes in database records",
        "Confirmed confirmation alerts and redirect destinations"
      ],
      "practice": {
        "title": "Positive functional test matrix creation",
        "brief": "Create a comprehensive positive test suite for a shopping cart checkout flow."
      },
      "resources": [
        {
          "type": "tool",
          "name": "Playwright Official Getting Started",
          "url": "https://playwright.dev/docs/intro",
          "lang": "EN",
          "free": true
        },
    ...
    },
    {
      ...
      "practical": {
        ...
        "scenario": "The leave request form is boundary-tested against an employee with exactly 5 days of remaining leave balance.",
      ...
      "checklist": [
        "Identified lower and upper boundaries for all numeric fields",
        "Tested 3 points (B-1, B, B+1) at every identified boundary",
        "Audited comparison operators (< vs <=, > vs >=) in code"
      ],
      "practice": {
        "title": "Boundary value analysis test plan",
        "brief": "Construct a 3-point boundary table for a discount coupon code with 8-16 char length limits."
      },
      "resources": [
        {
          "type": "guide",
          "name": "Boundary Value Analysis in Software Testing",
        ...
        {
          "type": "tool",
          "name": "Jest Parameterized Testing Docs",
    ...
    },
    {
      ...
      "checklist": [
        "Categorized all valid and invalid input partitions",
        "Selected exactly one representative value per equivalence class",
        "Combined partition tests with boundary checks at class transitions"
      ],
      "practice": {
        "title": "Equivalence partition table design",
        "brief": "Design an equivalence class table for an airline baggage weight fee calculator."
      },
      "resources": [
        {
          "type": "guide",
          "name": "Black-box Test Design Techniques (ISTQB)",
          "url": "https://www.istqb.org",
          "lang": "EN",
          "free": true
        },
        {
          "type": "guide",
          "name": "Equivalence Class Partitioning Explained",
    ...
    },
    {
      ...
      "checklist": [
        "Configured reproducible random seed (-s) for debugging",
        "Monitored system memory and heap allocations during runs",
        "Audited app response times after sustained monkey event bursts"
      ],
      "practice": {
        "title": "Android Monkey stability session",
        "brief": "Run a 25,000-event monkey test session on an Android APK and capture any ANR traces."
      },
      "resources": [
        {
          "type": "tool",
          "name": "Android Studio UI/Application Exerciser Monkey",
          "url": "https://developer.android.com/studio/test/other-testing-tools/monkey",
          "lang": "EN",
          "free": true
        },
    ...
    },
    {
      ...
      "checklist": [
        "Verified multi-replica container redundancy across availability zones",
        "Audited load balancer health check interval thresholds (<= 5s)",
        "Enforced automated alerts on unrecovered pod terminations"
      ],
      "practice": {
        "title": "Chaos engineering experiment design",
        "brief": "Design a chaos experiment injecting 200ms latency on a database connection."
      },
      "resources": [
        {
          "type": "tool",
          "name": "Netflix Chaos Monkey GitHub",
          "url": "https://github.com/Netflix/chaosmonkey",
          "lang": "EN",
          "free": true
        },
    ...
    },
    {
      ...
      "checklist": [
        "Published versioned pact contracts to central Pact Broker",
        "Configured can-i-deploy gating checks in GitHub Actions CI",
        "Verified provider satisfies all active consumer contract versions"
      ],
      "practice": {
        "title": "Pact contract test implementation",
        "brief": "Write a consumer Pact test for an employee profile endpoint and verify it against a Mock Service."
      },
      "resources": [
        {
          "type": "tool",
          "name": "Pact Official Documentation",
        ...
        {
          "type": "tool",
          "name": "PactFlow Hosted Contract Platform",
    ...
    },
    {
      ...
      "checklist": [
        "Identified all critical read-then-write database transactions",
        "Configured synchronizing thread rendezvous barriers in JMeter",
        "Verified database row locking (SELECT FOR UPDATE) and transaction isolation"
      ],
      "practice": {
        "title": "Concurrency race condition probe",
        "brief": "Set up a JMeter test firing 50 simultaneous debit requests against a bank account with $100 balance."
      },
      "resources": [
        {
          "type": "tool",
          "name": "Apache JMeter Documentation",
        ...
        {
          "type": "guide",
          "name": "Concurrency Control & Race Conditions in Databases",
    ...
    },
    {
      ...
      "practical": {
        ...
        "scenario": "The HRMS is configuration-tested with the \"multi-currency payroll\" feature flag toggled on, a setting only a subset of customers actually enable.",
      ...
      "checklist": [
        "Defined configuration matrix weighted by production user analytics",
        "Verified all application feature flags in both enabled and disabled states",
        "Audited locale and regional date/currency formatting variants"
      ],
      "practice": {
        "title": "Configuration matrix test design",
        "brief": "Design a test matrix covering 3 OS variants, 3 browsers, and 2 feature flags for a media editor."
      },
      "resources": [
        {
          "type": "tool",
          "name": "LambdaTest Cross Browser Cloud",
          "url": "https://www.lambdatest.com",
          "lang": "EN",
          "free": true
        },
        {
          "type": "guide",
          "name": "Configuration Testing Overview",
          "url": "https://en.wikipedia.org/wiki/Configuration_testing",
          "lang": "EN",
          "free": true
        }
      ],
    ...
    },
    {
      ...
      "checklist": [
        "Verified 1:1 row count parity across all migrated database tables",
        "Audited transformation logic for NULL values, dates, and Unicode characters",
        "Tested and timed the database rollback script in staging"
      ],
      "practice": {
        "title": "Database migration reconciliation plan",
        "brief": "Design an SQL audit script validating 50,000 customer records after schema normalization."
      },
      "resources": [
        {
          "type": "tool",
          "name": "DBeaver Community Database Tool",
          "url": "https://dbeaver.io",
          "lang": "EN",
          "free": true
        },
        {
          "type": "guide",
          "name": "Database Migration Testing Best Practices",
    ...
    },
    {
      ...
      "checklist": [
        "Measured actual Recovery Time Objective (RTO) against SLAs",
        "Audited maximum data loss window against Recovery Point Objective (RPO)",
        "Updated recovery runbooks with current credentials and tooling changes"
      ],
      "practice": {
        "title": "Disaster recovery runbook authoring",
        "brief": "Author a step-by-step DR runbook for restoring a Redis cache and PostgreSQL cluster from S3."
      },
      "resources": [
        {
          "type": "guide",
        ...
        {
          "type": "guide",
          "name": "Disaster Recovery Testing Guide",
    ...
    },
    {
      ...
      "practical": {
        ...
        "scenario": "A tester follows the public API documentation's example request for creating a leave request exactly as written.",
      ...
      "checklist": [
        "Executed all cURL commands and code samples verbatim",
        "Audited all UI screenshots against current design system",
        "Tested all hyperlinks and cross-references for 404 broken links"
      ],
      "practice": {
        "title": "API documentation testing audit",
        "brief": "Follow an onboarding QuickStart guide from scratch on a clean VM and log every point of friction."
      },
      "resources": [
        {
          "type": "guide",
        ...
        {
          "type": "guide",
          "name": "Documentation Testing Explained",
          "url": "https://www.guru99.com/software-testing-documentation.html",
          "lang": "EN",
          "free": true
        }
      ],
    ...
    },
    {
      ...
      "practical": {
        ...
        "scenario": "The HRMS's \"right to erasure\" feature is compliance-tested against GDPR's requirement that a user's personal data be genuinely and completely removed on request.",
      ...
      "checklist": [
        "Verified complete data removal across primary tables and backups",
        "Audited AES-256 encryption at rest and TLS 1.3 in transit",
        "Logged timestamped test evidence for external compliance auditors"
      ],
      "practice": {
        "title": "GDPR Right to Erasure verification test",
        "brief": "Design an automated test that triggers an account deletion and audits 6 downstream tables for PII leaks."
      },
      "resources": [
        {
          "type": "guide",
          "name": "Official GDPR Legal Text",
        ...
        {
          "type": "tool",
          "name": "axe DevTools Accessibility Engine",
          "url": "https://www.deque.com/axe/devtools/",
          "lang": "EN",
          "free": true
        }
    ...
    },
    {
      ...
      "checklist": [
        "Established clear escalation communication channels for pilot users",
        "Monitored support ticket volume and resolution turnaround time",
        "Resolved critical operational bottlenecks before widening release to 100%"
      ],
      "practice": {
        "title": "Pilot rollout plan design",
        "brief": "Create a 4-week pilot deployment plan for introducing an expense tracking tool to a sales team."
      },
      "resources": [
        {
          "type": "guide",
          "name": "Pilot Testing in Software Engineering",
          "url": "https://www.geeksforgeeks.org/pilot-testing-software-testing/",
          "lang": "EN",
          "free": true
        },
        {
          "type": "guide",
          "name": "Phased Rollout Strategies",
          "url": "https://martinfowler.com/bliki/PhasedRelease.html",
          "lang": "EN",
          "free": true
        }
      ],
    ...
    },
    {
      ...
      "checklist": [
        "Processed live inputs through both systems concurrently for multiple cycles",
        "Audited every output field discrepancy down to precision rounding decimals",
        "Retained legacy engine as authoritative source until 100% parity verified"
      ],
      "practice": {
        "title": "Parallel testing comparison suite",
        "brief": "Write a Python script that diffs output JSON from legacy and modern invoice calculation endpoints."
      },
      "resources": [
        {
          "type": "tool",
          "name": "DBeaver SQL Comparison Tools",
          "url": "https://dbeaver.io",
          "lang": "EN",
          "free": true
        },
        {
          "type": "guide",
          "name": "Parallel Testing Explained",
          "url": "https://www.guru99.com/parallel-testing.html",
          "lang": "EN",
          "free": true
        }
      ],
    ...
    },
    {
      ...
      "practical": {
        ...
        "scenario": "The HRMS's authentication, leave management, and payroll modules are integrated using an incremental approach: authentication first, then leave management against verified authentication, then payroll against both.",
      ...
      "checklist": [
        "Defined dependency DAG (directed acyclic graph) for module integration order",
        "Created lightweight mocks/stubs for downstream modules pending completion",
        "Executed integration regression assertions at each component addition phase"
      ],
      "practice": {
        "title": "Incremental integration sequence plan",
        "brief": "Map out a 4-stage incremental integration plan for an E-commerce store (Auth -> Catalog -> Cart -> Payment)."
      },
      "resources": [
        {
          "type": "tool",
          "name": "Playwright API Mocking Docs",
        ...
        {
          "type": "guide",
          "name": "Integration Testing Strategies (ISTQB)",
          "url": "https://www.istqb.org",
          "lang": "EN",
          "free": true
        }
    ...
    },
    {
      ...
      "practical": {
        ...
        "scenario": "A single Selenium script tests leave request date validation, driven by a CSV with 15 rows covering valid, invalid, and boundary dates.",
      ...
      "steps": [
        {
          ...
          "body": "One script, many CSV rows.",
          "learnMore": null,
          "image": null,
          "resources": [],
          "quiz": null,
          "tryIt": null,
          "doThis": "Add a 16th row for a new edge case without changing the script.",
          "tip": null,
          "code": null,
          "codeTitle": null,
          "items": null,
      ...
      "checklist": [
        "External data source with expected results",
        "Script iterates one row per case",
        "New cases added as rows only"
      ],
      "resources": [
        {
          "type": "tool",
    ...
    },
    {
      ...
      "practical": {
        ...
        "scenario": "A QA analyst with no programming background writes a Robot Framework case using Login As Manager, Navigate To Pending Requests, Approve Request, Verify Leave Balance Updated.",
      ...
      "steps": [
        {
          "title": "Author in keywords",
          "body": "Engineers maintain the library; analysts write cases.",
          "learnMore": null,
          "image": null,
          "resources": [],
          "quiz": null,
          "tryIt": null,
          "doThis": "Write one Robot Framework case from existing keywords.",
          "tip": null,
          "code": null,
          "codeTitle": null,
          "items": null,
      ...
      "checklist": [
        "Keyword library covers the flow",
        "Case is readable by a non-programmer",
    ...
    },
    {
      ...
      "practical": {
        ...
        "scenario": "Draft → Submitted → Approved/Rejected → Cancelled is modeled in GraphWalker, generating paths that cover every valid transition at least once.",
      ...
      "steps": [
        {
          "title": "Model then generate",
          "body": "Bind abstract steps to real automation.",
          "learnMore": null,
          "image": null,
          "resources": [],
          "quiz": null,
          "tryIt": null,
          "doThis": "Sketch the leave-request state graph and name one invalid edge.",
          "tip": null,
          "code": null,
          "codeTitle": null,
          "items": null,
      ...
      "checklist": [
        "States and transitions modeled",
        "Coverage strategy chosen",
        "Abstract steps bound to real actions"
      ],
      "resources": [
        {
          "type": "tool",
    ...
    },
    {
      ...
      "practical": {
        ...
        "scenario": "Payroll calculation is High risk; the company-news announcement feature is Low risk.",
      ...
      "steps": [
        {
          "title": "Score then allocate",
          "body": "Likelihood × impact → High/Medium/Low → testing depth.",
          "learnMore": null,
          "image": null,
          "resources": [],
          "quiz": null,
          "tryIt": null,
          "doThis": "Rate three features in your current release.",
          "tip": null,
          "code": null,
          "codeTitle": null,
          "items": null,
      ...
      "checklist": [
        ...
        "Depth allocated proportionally",
        "Assessment dated for revisit"
      ],
      "resources": [
        {
          "type": "guide",
          "name": "ISTQB risk-based testing",
          "url": "https://www.istqb.org",
          "lang": "EN",
          "free": true
        }
    ...
    },
    {
      ...
      "steps": [
        {
          "title": "Trigger then inspect storage",
          "body": "Postman for the API surface; DBeaver for stored state.",
          "learnMore": null,
          "image": null,
          "resources": [],
          "quiz": null,
          "tryIt": null,
          "doThis": "Verify one multi-table business rule in the database.",
          "tip": null,
          "code": null,
          "codeTitle": null,
          "items": null,
      ...
      "checklist": [
        "API inputs chosen deliberately",
        "Database state checked",
        "Scheduled job exercised"
      ],
      "resources": [
        {
          "type": "tool",
    ...
    },
    {
      ...
      "steps": [
        {
          "title": "Capture and throttle",
          "body": "Wireshark for packets; DevTools/OS tools for poor conditions.",
          "learnMore": null,
          "image": null,
          "resources": [],
          "quiz": null,
          "tryIt": null,
          "doThis": "Confirm HTTPS is actually used and a dropped request does not hang forever.",
          "tip": null,
          "code": null,
          "codeTitle": null,
          "items": null,
      ...
      "checklist": [
        "Traffic filtered to the app",
        "Encryption in transit confirmed",
        "Poor-network behavior checked"
      ],
      "resources": [
        {
          "type": "tool",
    ...
    },
    {
      ...
      "steps": [
        {
          "title": "toMatchSnapshot then review diffs",
          "body": "Never blindly update.",
          "learnMore": null,
          "image": null,
          "resources": [],
          "quiz": null,
          "tryIt": null,
          "doThis": "Add one snapshot test and read a deliberate fail diff.",
          "tip": null,
          "code": null,
          "codeTitle": null,
          "items": null,
      ...
      "checklist": [
        ...
        "Diffs reviewed before update",
        "Interaction tests still cover behavior"
      ],
      "resources": [
        {
          "type": "tool",
    ...
    },
    {
      ...
      "steps": [
        {
          "title": "Moderate load, long duration",
          "body": "Watch drift, not just spikes.",
          "learnMore": null,
          "image": null,
          "resources": [],
          "quiz": null,
          "tryIt": null,
          "doThis": "Name the resource you would plot start-vs-end on a soak.",
          "tip": null,
          "code": null,
          "codeTitle": null,
          "items": null,
      ...
      "checklist": [
        "Load is moderate not peak",
        "Duration is hours to days",
        "Start vs end health compared"
      ],
      "resources": [
        {
          "type": "tool",
    ...
    },
    {
      ...
      "steps": [
        {
          "title": "Wire the suite into CI",
          "body": "Fail the check on red; block merge with branch protection.",
          "learnMore": null,
          "image": null,
          "resources": [],
          "quiz": null,
          "tryIt": null,
          "doThis": "Add a test workflow that runs on push and pull_request.",
          "tip": null,
          "code": null,
          "codeTitle": null,
          "items": null,
      ...
      "checklist": [
        ...
        "Failed tests fail the check",
        "Slow suites scheduled separately"
      ],
      "resources": [
        {
          "type": "tool",
    ...
    },
    {
      ...
      "steps": [
        {
          "title": "Hit the real partner",
          "body": "Save the exchange as a Postman collection.",
          "learnMore": null,
          "image": null,
          "resources": [],
          "quiz": null,
          "tryIt": null,
          "doThis": "Send a well-formed and an error-path request to the sandbox.",
          "tip": null,
          "code": null,
          "codeTitle": null,
          "items": null,
    ...
    },
    {
      ...
      "steps": [
        {
          "title": "Validate then fix the template",
          "body": "Prioritize unclosed tags and invalid nesting.",
          "learnMore": null,
          "image": null,
          "resources": [],
          "quiz": null,
          "tryIt": null,
          "doThis": "Submit one public page to validator.w3.org.",
          "tip": null,
          "code": null,
          "codeTitle": null,
          "items": null,
    ...
    },
    {
      ...
      "steps": [
        {
          "title": "Scan then lengthen",
          "body": "Move UI copy into resources; test a doubled placeholder locale.",
          "learnMore": null,
          "image": null,
          "resources": [],
          "quiz": null,
          "tryIt": null,
          "doThis": "Flag one hard-coded label and one layout that breaks when text is longer.",
          "tip": null,
          "code": null,
          "codeTitle": null,
          "items": null,
      ...
      "checklist": [
        "Hard-coded UI strings moved",
        "Long-text layout checked",
        "Unicode end to end",
    ...
    },
    {
      ...
      "steps": [
        {
          "title": "Capture, document, compare",
          "body": "Same plan, same conditions; re-baseline on purpose.",
          "learnMore": null,
          "image": null,
          "resources": [],
          "quiz": null,
          "tryIt": null,
          "doThis": "Name the metric and conditions you would save as a baseline.",
          "tip": null,
          "code": null,
          "codeTitle": null,
          "items": null,
      ...
      "checklist": [
        ...
        "Results saved as named baseline",
        "Meaningful degradation flagged"
      ],
      "resources": [
        {
          "type": "tool",
    ...
    },
    {
      ...
      "steps": [
        {
          "title": "Same scenarios, matched captures",
          "body": "Spreadsheet scores; LambdaTest for equivalent screenshots.",
          "learnMore": null,
          "image": null,
          "resources": [],
          "quiz": null,
          "tryIt": null,
          "doThis": "Write one specific difference, not “theirs feels easier.”",
          "tip": null,
          "code": null,
          "codeTitle": null,
          "items": null,
    ...
    },
    {
      ...
      "steps": [
        {
          "title": "Inside, edge, outside per field",
          "body": "Document in TestLink; reuse across releases.",
          "learnMore": null,
          "image": null,
          "resources": [],
          "quiz": null,
          "tryIt": null,
          "doThis": "Define the domain for one field and name three values.",
          "tip": null,
          "code": null,
          "codeTitle": null,
          "items": null,
    ...
    },
    {
      ...
      "steps": [
        {
          "title": "Checklist plus ZAP",
          "body": "Usual suspects, then scan for leaky errors.",
          "learnMore": null,
          "image": null,
          "resources": [],
          "quiz": null,
          "tryIt": null,
          "doThis": "Double-submit one form and check for duplicate records.",
          "tip": null,
          "code": null,
          "codeTitle": null,
          "items": null,
      ...
      "checklist": [
        "Usual-suspect checklist",
        "No leaky error messages",
        "State consistent after errors",
        "Findings logged with repro steps"
      ],
      "resources": [
        {
          "type": "tool",
    ...
    },
    {
      ...
      "steps": [
        {
          "title": "Report, then write the missing branch test",
          "body": "Prefer branch coverage over statement-only.",
          "learnMore": null,
          "image": null,
          "resources": [],
          "quiz": null,
          "tryIt": null,
          "doThis": "Open a coverage HTML report and name one red branch.",
          "tip": null,
          "code": null,
          "codeTitle": null,
          "items": null,
      ...
      "checklist": [
        ...
        "Red branches identified",
        "New tests for those paths",
    ...
    },
    {
      ...
      "steps": [
        {
          "title": "Trigger the alert; restore the backup",
          "body": "A dashboard existing is not the same as an alert firing.",
          "learnMore": null,
          "image": null,
          "resources": [],
          "quiz": null,
          "tryIt": null,
          "doThis": "Walk a restore from a real backup file, not just confirm the file exists.",
          "tip": null,
          "code": null,
          "codeTitle": null,
          "items": null,
      ...
      "checklist": [
        ...
        "Restore verified",
        "Fresh person follows the runbook"
      ],
      "resources": [
        {
          "type": "tool",
    ...
    },
    {
      ...
      "steps": [
        {
          "title": "Ramp past the scale threshold",
          "body": "Watch the transition, not only steady state.",
          "learnMore": null,
          "image": null,
          "resources": [],
          "quiz": null,
          "tryIt": null,
          "doThis": "Name one inconsistency you would look for when a second instance joins.",
          "tip": null,
          "code": null,
          "codeTitle": null,
          "items": null,
      ...
      "checklist": [
        "Load past auto-scale",
        "Consistency during transition",
        "Multi-region if applicable",
        "Failure of an instance/zone considered"
      ],
      "resources": [
        {
          "type": "tool",
    ...
    },
    {
      ...
      "steps": [
        {
          "title": "Capture, change, diff",
          "body": "If unintentional, fix the code, not the master.",
          "learnMore": null,
          "image": null,
          "resources": [],
          "quiz": null,
          "tryIt": null,
          "doThis": "Run diff on two output files and classify one difference.",
          "tip": null,
          "code": null,
          "codeTitle": null,
          "items": null,
      ...
      "checklist": [
        "Trusted output saved",
        "Same inputs re-run",
        "Diff reviewed",
        "Master updated only for intentional change"
      ],
      "resources": [
        {
          "type": "guide",
    ...
    },
    {
      ...
      "steps": [
        {
          "title": "Guide, then lint, then human clarity",
          "body": "Vale catches drift; people catch unclear wording.",
          "learnMore": null,
          "image": null,
          "resources": [],
          "quiz": null,
          "tryIt": null,
          "doThis": "Pick one concept and write the single approved term.",
          "tip": null,
          "code": null,
          "codeTitle": null,
          "items": null,
      ...
      "checklist": [
        ...
        "Vale (or equivalent) run",
        "Clarity reviewed by a human",
        "Templated text checked with real data"
      ],
      "resources": [
        {
          "type": "tool",
    ...
    },
    {
      ...
      "steps": [
        {
          "title": "Flags, second tab, timeout, tamper",
          "body": "Application panel → Cookies.",
          "learnMore": null,
          "image": null,
          "resources": [],
          "quiz": null,
          "tryIt": null,
          "doThis": "Confirm Secure and HttpOnly on the session cookie after login.",
          "tip": null,
          "code": null,
          "codeTitle": null,
          "items": null,
      ...
      "checklist": [
        "Secure and HttpOnly checked",
        "Expiry matches intended timeout",
        "Multi-tab behavior verified",
        "Invalid cookie handled gracefully"
      ],
      "resources": [
        {
          "type": "tool",
    ...
    },
    {
      ...
      "steps": [
        {
          "title": "Overrides, lifecycle, polymorphism",
          "body": "Review that overrides specialize meaning, they do not change it.",
          "learnMore": null,
          "image": null,
          "resources": [],
          "quiz": null,
          "tryIt": null,
          "doThis": "Name one override and the parent contract it must still honor.",
          "tip": null,
          "code": null,
          "codeTitle": null,
          "items": null,
      ...
      "checklist": [
        "Parent contract tested on overrides",
        "Lifecycle sequenced",
        "Polymorphic dispatch checked",
        "Deep chains reviewed"
      ],
      "resources": [
        {
          "type": "guide",
          "name": "Unit testing (Chapter 1)",
          "url": "https://hearth-learn.vercel.app/manuals/testing-types",
          "lang": "EN",
          "free": true
        }
    ...
    },
    {
      ...
      "steps": [
        {
          "title": "Audit, then live offline and install",
          "body": "Lighthouse score is configuration; offline and home-screen are lived experience.",
          "learnMore": null,
          "image": null,
          "resources": [],
          "quiz": null,
          "tryIt": null,
          "doThis": "Set Network to Offline and confirm the app still renders something of its own.",
          "tip": null,
          "code": null,
          "codeTitle": null,
          "items": null,
      ...
      "checklist": [
        ...
        "Re-audited after SW/manifest changes"
      ],
      "resources": [
        {
          "type": "tool",
    ...
    },
    {
      ...
      "steps": [
        {
          "title": "Add one module to a known-good core",
          "body": "Stop on red before the next join. Do not collapse stages into one Big Bang script.",
          "learnMore": null,
          "image": null,
          "resources": [],
          "quiz": null,
          "tryIt": null,
          "doThis": "Write three staged Selenium tests: Attendance, Attendance+Leave, then all three.",
          "tip": null,
          "code": null,
          "codeTitle": null,
          "items": null,
      ...
      "checklist": [
        "Core tested alone",
        "Next module added only after green",
        "Failure localized to the new boundary",
        "Stages kept in CI, not collapsed"
      ],
      "resources": [
        {
          "type": "tool",
    ...
    },
    {
      ...
      "steps": [
        {
          "title": "Jump, hold, drop, recover",
          "body": "A multi-minute climb is load; raising the peak to find a ceiling is stress.",
          "learnMore": null,
          "image": null,
          "resources": [],
          "quiz": null,
          "tryIt": null,
          "doThis": "Write a k6 stages array that reaches peak in ~10 seconds, not over a minute.",
          "tip": null,
          "code": null,
          "codeTitle": null,
          "items": null,
      ...
      "checklist": [
        "Jump is seconds, not a slow ramp",
        "Peak SLAs checked",
        "Recovery after drop-back checked",
        "Not confused with load (Ch 14) or stress (Ch 15)"
      ],
      "resources": [
        {
          "type": "tool",
    ...
    },
    {
      ...
      "steps": [
        {
          "title": "Charter, time-box, notes, debrief",
          "body": "A finding without a ticket or new scripted case is only a note.",
          "learnMore": null,
          "image": null,
          "resources": [],
          "quiz": null,
          "tryIt": null,
          "doThis": "Write one charter for Rule Groups and list the follow-up you would take from a finding.",
          "tip": null,
          "code": null,
          "codeTitle": null,
          "items": null,
      ...
      "checklist": [
        ...
        "Timer running",
        "Notes timestamped",
        "Debrief with explicit follow-up"
      ],
      "resources": [
        {
          "type": "tool",
    ...
    },
    {
      ...
      "steps": [
        {
          "title": "Script the dialogue, including fallback",
          "body": "Assert the bot’s words and context, not only HTTP 200.",
          "learnMore": null,
          "image": null,
          "resources": [],
          "quiz": null,
          "tryIt": null,
          "doThis": "Write a two-turn leave-balance convo plus one unknown-intent turn.",
          "tip": null,
          "code": null,
          "codeTitle": null,
          "items": null,
      ...
      "checklist": [
        "Happy-path multi-turn convo",
        "Unknown intent fallback",
        "Context kept on follow-up",
        "Utterance variants, not one canonical phrase"
      ],
      "resources": [
        {
          "type": "tool",
