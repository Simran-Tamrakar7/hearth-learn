...
| File | What |
|---|---|
| `schema.prisma` | models (User prefs/lastActive, ManualHighlight reviewLater, LifeLabAttempt, SiteConfig, ShowcaseItem portfolio fields, PasswordResetToken code/session, …) |
