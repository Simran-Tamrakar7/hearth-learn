...
import { TESTING_TYPES_CHAPTERS } from "@/app/manuals/_content/testing-types/catalog";

export type { TestingChapterData } from "@/app/manuals/_content/testing-types/types";
