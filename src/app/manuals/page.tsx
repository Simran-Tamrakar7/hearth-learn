...
export default function ManualsCatalogPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#FBF8F3] text-[#1C2A26]">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-10 sm:py-12 w-full space-y-10 flex-1">
        {/* CATALOG HEADER WITH BALANCED PADDING & SPACING */}
        <div className="bg-gradient-to-br from-white via-[#FAF7F2] to-[#F5EFE6] border border-[#E7E0D3] rounded-3xl p-8 sm:p-12 space-y-6 shadow-sm relative overflow-hidden">
            ...
            <div className="space-y-4 w-full">
              <div className="flex flex-wrap items-center gap-3">
                ...
                <span className="text-xs font-semibold text-[#8A9B95]">
                  {MANUALS_DATA.length} Manuals • {categories.length - 1} Categories
                </span>
              </div>
          ...
          {/* SEARCH INPUT BAR WITH BALANCED MARGIN & HEIGHT */}
          <div className="pt-2 sm:max-w-md">
            <div className="relative">
              ...
              <input
                ...
                placeholder="Search manuals: Git, Playwright, Foundations..."
        ...
        {/* CATEGORY FILTER CHIPS WITH EVEN PADDING & GAPS */}
        <div className="flex flex-wrap items-center gap-2.5 border-b border-[#E7E0D3] pb-6 overflow-x-auto">
          {categories.map((cat) => (
            <button
              key={cat}
        ...
        {/* MANUAL CARDS RESPONSIVE GRID WITH ENHANCED CARD PADDING & GAPS */}
                  ...
                  <div>
                    ...
                    <div className="p-7 space-y-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <p className="text-xs sm:text-sm text-[#52635E] line-clamp-3 leading-relaxed">
                          {manual.description}
                        </p>
                      </div>
                    </div>
