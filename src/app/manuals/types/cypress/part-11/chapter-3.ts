...
export const chapter = {
  ...
  "blocks": [
    ...
    },
    {
      ...
      "content": "- A URL per run (paste into the PR).\n- Spec duration history → **smarter shards** than folder globs.\n- Flake detection across attempts (pairs with 9.13 / 10.3 — still fix the test).\n- Hosted screenshots/videos/Test Replay depending on plan (9.12, 11.4).",
      "order": 1
    },
    {
      "id": "cy-11-3-md-2",
      ...
      "content": "- WebKit, multi-tab, or a Trace Viewer zip.\n- Permission to skip `wait-on` or `data-cy`.\n- Extra assertions. Cloud is orchestration and visibility (Part 0.1).",
      "order": 2
    },
    {
      "id": "cy-11-3-md-3",
      "type": "overview",
      "heading": "Privacy",
      "content": "Payroll videos are compensation data. Legal may forbid `--record` to Cypress.io. Then use 11.5 (Sorry Cypress / Currents) or no record + artifacts (11.8).",
      "order": 3
    },
    {
      "id": "cy-11-3-md-4",
      ...
      "content": "Playwright OSS already shards and ships `trace.zip` without a Cypress-like paywall for *balancing*. Selenium + Sauce/BrowserStack is the old vendor-dashboard model. Cypress Cloud is closer to \"a dashboard that speaks Cypress spec files\" plus flake UI. Do not tell a Playwright team they \"need Cloud to see traces.\"\n\nInterview line: \"Cloud records runs and load-balances specs across machines. I can run 100% of Cypress without it. I pay when CI orchestration and hosted replay matter — not because the runner is incomplete.\"",
      "order": 4
    }
  ],
  "advantages": [
