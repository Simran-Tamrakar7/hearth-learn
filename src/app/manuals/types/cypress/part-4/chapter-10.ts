...
export const chapter = {
  ...
  advantages: ["Cloud dynamic load-balance","cypress-parallel free local","CI matrix shards","Spec isolation default","Record key dashboard","Historical timing aware"],
  limitations: ["Spec-file not test-case grain","Cloud paid for smart balance","Naive matrix imbalance","Launch overhead per spec","Flakes amplify parallel","Record key secrets"],
  tools: [],
