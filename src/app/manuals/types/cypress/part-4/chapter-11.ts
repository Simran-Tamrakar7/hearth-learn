...
export const chapter = {
  ...
  advantages: ["chrome firefox edge electron","before:browser:launch flags","Launchpad browser pick","CI per-browser jobs","Electron default headless","viewport presets UX"],
  limitations: ["no WebKit ever","viewport ≠ UA/touch","no geolocation API stub","Firefox less mature","multiplies CI time","not real devices"],
  tools: [],
