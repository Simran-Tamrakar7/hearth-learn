...
export const chapter = {
  ...
  advantages: ["onBeforeLoad locale stub","cookie preference pattern","data-cy locale-safe","visual RTL checks","unit date formats","intercept locale APIs"],
  limitations: ["no built-in locale/TZ","text selectors brittle","RTL needs visuals","timezone hard in E2E","font fallback flakes","translation lag"],
  tools: [],
