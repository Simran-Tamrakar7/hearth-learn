...
export const chapter = {
  ...
  advantages: ["before:browser:launch","cy.clock/tick","window console spy","cy.task Node bridge","cucumber preprocessor","cy.session OAuth"],
  limitations: ["clock skips real timers only","task needs nodeEvents","cucumber adds complexity","OAuth origin limits","spies need visit hook","plugins version drift"],
  tools: [],
