...
export const chapter = {
  ...
  advantages: ["video default on","screenshot on fail","Cloud Test Replay","Command Log local","CI artifact upload","no extra trace API"],
  limitations: ["no portable trace.zip","videos large/costly","Replay is Cloud","free tier manual","headless no time-travel","retention policies"],
  tools: [],
