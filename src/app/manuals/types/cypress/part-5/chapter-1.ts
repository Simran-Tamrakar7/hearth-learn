...
export const chapter = {
  ...
  advantages: ["official github-action","binary cache","smoke vs regression","always() artifacts","record parallel Cloud","matrix browsers"],
  limitations: ["video storage cost","binary large","secrets for record key","flake noise PRs","Windows runners slower","action version pin"],
  tools: [],
