...
export const chapter = {
  ...
  advantages: ["CI badge","Mochawesome sample","App Actions writeup","Cypress vs PW note","public artifacts","clear README"],
  limitations: ["secret scrubbing","report PII","badge flake","stale screenshots","overclaim coverage","private app demos"],
  tools: [],
