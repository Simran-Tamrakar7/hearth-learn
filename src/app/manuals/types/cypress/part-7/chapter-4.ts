...
export const chapter = {
  ...
  overviewText: "Cypress thrives in JS/dev-led cultures; Cloud skills matter at scale; component testing fits the pyramid; pair Cypress+Playwright+Appium; push data-cy as shift-left collaboration.",
