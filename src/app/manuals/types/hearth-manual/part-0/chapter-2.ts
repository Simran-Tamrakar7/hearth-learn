...
export const chapter = {
  ...
  advantages: ["All layers traceable to package.json and src/ layout","Single SQLite file — simple local dev","Feature modules colocated under src/app/<feature>/"],
  limitations: ["SQLite on Vercel uses /tmp — ephemeral unless configured","No separate BFF — API routes colocated in src/app/api/"],
  tools: [],
