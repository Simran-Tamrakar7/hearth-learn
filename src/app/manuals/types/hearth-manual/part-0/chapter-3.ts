...
export const chapter = {
  ...
  overviewText: "The stack is defined in package.json: Next 16.3.0, React 19.2.8, Prisma 5.22, NextAuth 4.24, Tailwind 4, TypeScript 5, plus docx/html2pdf for manual export and framer-motion for landing animations.",
