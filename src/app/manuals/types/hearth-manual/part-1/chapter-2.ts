...
export const chapter = {
  ...
  advantages: ["Every var traced to a source file","Sensible local defaults for DATABASE_URL and NEXTAUTH"],
  limitations: ["No .env.example — drift risk vs docs/local-dev.md"],
  tools: [],
