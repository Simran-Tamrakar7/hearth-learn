...
export const chapter = {
  ...
  tools: [],
  contentMarkdown: "## 4.13.1 What It Does (User View)\n\nSettings: theme, reading prefs. Admin: user approval, permissions, site feature toggles.\n\n## 4.13.2 How It's Implemented (Dev View)\n\nsettings/page.tsx → /api/me/prefs. admin/page.tsx → /api/admin/users, /api/admin/features.\n\n## 4.13.3 Data Touched\n\nUser.prefs, SiteConfig.features JSON.\n\n## 4.13.4 Edge Cases & Known Limitations\n\n/api/settings exists but settings page does not call it.\n\n## 4.13.5 Related Chapters\n\nhm-6-1",
  exercises: [],
  resourceLinks: [],
  steps: [],
  learn: [],
