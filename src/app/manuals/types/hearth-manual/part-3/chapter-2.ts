...
export const chapter = {
  ...
  advantages: ["Dedicated chapter for Dashboard with cited file paths","Five-part template matches other features"],
  limitations: ["Some Dashboard edge cases may need product confirmation"],
  tools: [],
