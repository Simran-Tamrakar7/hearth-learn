...
export const chapter = {
  ...
  advantages: ["Dedicated chapter for Toolkits with cited file paths","Five-part template matches other features"],
  limitations: ["Some Toolkits edge cases may need product confirmation"],
  tools: [],
