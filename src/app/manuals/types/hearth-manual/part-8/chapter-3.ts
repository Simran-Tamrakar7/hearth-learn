...
export const chapter = {
  ...
  advantages: ["Matches original user thread requirements","Stable cross-references via numbered parts"],
  limitations: ["Prompt length may exceed model context — batch by Part"],
  tools: [],
