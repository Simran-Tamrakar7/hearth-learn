...
export const chapter = {
  ...
  "practical": {
    ...
    "scenario": "Bizlevate's night-shift baseline is roughly 20 concurrent users. At 9:00 AM, several hundred employees open the app and tap Clock In within the same minute. A spike test jumps from 20 to 400 virtual users in 10 seconds against login and clock-in, holds, then drops back to 20.",
  ...
  "tools": [
    {
      ...
      "steps": [
        {
          "t": "Step 1 — Install k6",
          "p": "CLI on the machine that will generate the burst.",
          "c": "brew install k6"
        },
        {
        ...
        },
        {
          ...
          "p": "Confirm VUs actually reach 400 within ~10s, not over a minute.",
          "c": "k6 run spike-clock-in.js"
        },
        {
          "t": "Step 5 — Judge peak and recovery separately",
          "p": "A green peak with a hung recovery is still a fail — the 2-minute tail after drop-back must return to baseline latency."
        },
        {
          "t": "Step 6 — Do not confuse with load or stress",
          "p": "If you lengthen the climb to several minutes, you are back in Chapter 14. If you keep raising the peak to find the ceiling, you are in Chapter 15."
        }
      ]
    },
    {
      ...
      "steps": [
        {
          "t": "Step 1 — Start from the Chapter 14 test plan",
          "p": "Same HTTP samplers: login, then clock-in. Change only how users arrive."
        },
        {
        ...
        {
          "t": "Step 3 — Listeners on error rate and p95",
          "p": "Watch the first 10 seconds separately from the hold, and the period after threads stop for recovery."
        },
        {
          "t": "Step 4 — Run headlessly",
          "p": "Avoid GUI overhead during the burst.",
          "c": "jmeter -n -t hrms_clockin_spike.jmx -l spike.jtl -e -o ./spike_report"
        },
        {
          "t": "Step 5 — Confirm it was a jump",
          "p": "Active threads should hit 400 in ~10s. If the graph is a slow slope, you ran a load test."
        }
      ]
    }
  ],
