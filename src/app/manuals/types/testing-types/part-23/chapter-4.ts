...
export const chapter = {
  ...
  "practical": {
    ...
    "scenario": "Bizlevate's assistant answers \"What's my remaining leave?\" and a follow-up \"What about sick leave?\" without sending the employee to the leave form. A Botium convo covers both turns plus a nonsense utterance.",
  ...
  "tools": [
    {
      ...
      "steps": [
        ...
        {
          "t": "Step 5 — Run the suite",
          "p": "Fail the build when a reply no longer matches.",
          "c": "npx mocha --timeout 20000 spec/botium.spec.js"
        },
        {
          "t": "Step 6 — Expand utterances, do not only the canonical phrase",
          "p": "\"sick days left,\" \"how much SL,\" \"remaining sick\" — NLU drift is how conversational bugs return after a pass."
        }
      ]
    }
  ],
