...
export function getDishMatchedImage(dish: DetailedDish): string {
  if (dish.id.startsWith("user-") && dish.imageUrl) return dish.imageUrl;
...
function generate500PlusCookbookDishes(): DetailedDish[] {
  ...
  const cuisineDishCatalog: Record<string, string[]> = {
    "Nepali": [
    ...
    "Food Hero kitchen": [
      "Apple Spice Cinnamon Oatmeal",
      "Berry Spinach Power Smoothie Bowl",
      "High-Protein Quinoa Grain Bowl",
      "Avocado & Poached Egg Sourdough Toast",
      "Overnight Chia & Mango Parfait",
      "Sweet Potato & Black Bean Bowl",
      "Matcha Green Tea Chia Energy Latte",
      "Grilled Salmon & Roasted Asparagus",
      "Roasted Chickpea & Kale Power Salad",
      "Turmeric Ginger Anti-Inflammatory Broth",
      "Golden Milk Honey Wellness Latte",
      "Acai Berry Antioxidant Energy Bowl",
      "Zucchini Noodle Pesto Primavera",
      "Cauliflower Crust Veggie Medley Pizza",
      "Baked Sweet Potato Fries & Garlic Aioli",
      "Egg White Spinach & Mushroom Frittata",
      "Almond Flour High-Protein Pancakes",
      "Chia Seed Mint Lemonade Tonic",
      "Smoked Salmon Dill & Cucumber Bites",
      "Stuffed Bell Peppers with Wild Rice",
      "Roasted Beetroot & Goat Cheese Salad",
      "Grilled Chicken Cobb Power Bowl",
      "Coconut Water Chia Electrolyte Cooler",
      "Dark Chocolate Avocado Superfood Mousse",
    ],
    "Italian": [
      ...
      "Rustic Tomato Basil Bruschetta",
      "Creamy Venetian Tiramisu",
      "Eggplant Parmigiana (Melanzane)",
      "Siciliano Arancini Risotto Balls",
      "Genoese Pesto Pasta with Potato & Beans",
      "Penne all'Arrabbiata Spicy Tomato Pasta",
      "Fettuccine Alfredo al Burro",
      "Osso Buco alla Milanese Veal Shank",
      "Potato Gnocchi al Sorrento",
      "Caprese Salad with Buffalo Mozzarella",
      "Minestrone Soup with Cannellini Beans",
      "Cannoli Siciliani with Sweet Ricotta",
      "Tuscan Ribollita Bread & Bean Soup",
      "Saltimbocca alla Romana Veal Escalope",
      "Veal Milanese Crispy Breaded Cutlet",
      "Calzone Farcito with Ricotta & Ham",
      "Panettone French Toast with Citrus Zest",
      "Affogato al Caffè Double Espresso",
      "Antipasto Misto Charcuterie Board",
      "Polenta Concia with Gorgonzola Cheese",
    ],
    "Indian": [
      "Creamy Butter Chicken (Murgh Makhani)",
      "Amritsari Chana Masala with Bhatura",
      "Hyderabadi Chicken Dum Biryani",
      "Palak Paneer (Spinach Cottage Cheese)",
      "Dal Makhani (Slow-Cooked Black Lentils)",
      "Crispy Potato Samosas with Tamarind Chutney",
      "Garlic Butter Tandoori Naan",
      "South Indian Masala Dosa with Sambar",
      "Chicken Tikka Skewers with Mint Chutney",
      "Mango Lassi & Cardamom Refreshment",
      "Malai Kofta in Creamy Gravy",
      "Kashmiri Rogan Josh Lamb Curry",
      "Aloo Gobi Matar Stir-Fry",
      "Pani Puri Golgappe Street Snack",
      "Gulab Jamun in Rose Syrup",
      "Shahi Korma Lamb with Cashew Paste",
      "Baingan Bharta Smoked Eggplant",
      "Spongy Rasgulla Cottage Cheese Balls",
      "Spicy Chicken Chettinad Pepper Fry",
      "Rajma Chawal Kidney Bean Stew",
      "Pav Bhaji Butter Spiced Mash",
      "Kerala Coconut Fish Curry",
      "Poha Flattened Rice Breakfast Bowl",
      "Kulfi Falooda Saffron Ice Cream",
    ],
    "Mexican": [
      "Tacos Al Pastor with Roasted Pineapple",
      "Enchiladas Verdes with Shredded Chicken",
      "Fresh Chunky Guacamole & House Chips",
      "Chilaquiles Verdes with Fried Eggs",
      "Carne Asada Burrito Bowl",
      "Cheesy Chipotle Chicken Quesadillas",
      "Sizzling Steak & Pepper Fajitas",
      "Cinnamon Sugar Churros with Chocolate",
      "Birria de Res Tacos with Consomé",
      "Huevos Rancheros on Corn Tortilla",
      "Tamales de Pollo en Hoja de Maíz",
      "Elote Street Corn with Cotija Cheese",
      "Carnitas Slow-Braised Pork Tacos",
      "Pozole Rojo Pork & Hominy Soup",
      "Chiles Rellenos Stuffed Poblano",
      "Sopa de Lima Yucateca Citrus Soup",
      "Tostadas de Camaron Avocado Bites",
      "Queso Fundido with Melted Cheese & Chorizo",
      "Arroz con Leche Cinnamon Rice Pudding",
      "Horchata Sweet Vanilla Rice Milk",
      "Flautas de Pollo Crispy Rolled Tacos",
      "Mexican Hot Chocolate with Canela",
      "Ceviche de Pescado with Lime & Cilantro",
    ...
    "Japanese": [
      ...
      "Glazed Teriyaki Salmon Rice Bowl",
      "Pork & Cabbage Gyoza Dumplings",
      "Charred Chicken Yakitori Skewers",
      "Crispy Vegetable & Shrimp Tempura",
      "Beef Gyudon Sweet Onion Rice Bowl",
      "Spicy Tuna Roll with Sriracha Mayo",
      "Chawanmushi Savory Steamed Egg Custard",
      "Takoyaki Octopus Balls with Bonito Flakes",
      "Cold Zaru Soba Noodles with Tsuyu Dip",
      "Unadon Grilled Freshwater Eel Bowl",
      "Matcha Green Tea Parfait Dessert",
      "Chicken Oyakodon Egg & Rice Bowl",
      "Japanese Fluffy Soufflé Pancakes",
      "Okonomiyaki Hiroshima Style Savory Pancake",
      "Sukiyaki Thin Slice Beef Hot Pot",
      "Agedashi Tofu in Dashi Broth",
      "Miso Glazed Black Cod (Gindara)",
      "Tamagoyaki Rolled Japanese Omelet",
      "Strawberry Daifuku Sweet Mochi",
      "Edamame with Sea Salt & Garlic Oil",
    ],
    "Thai": [
      "Classic Pad Thai Noodles with Shrimp",
      "Thai Green Curry Chicken (Gaeng Keow Wan)",
      "Spicy Tom Yum Goong Soup",
      "Sweet Mango Sticky Rice (Khao Niew Mamuang)",
      "Spicy Basil Pork (Pad Kra Pao)",
      "Rich Massaman Beef Curry",
      "Som Tum Green Papaya Salad",
      "Thai Red Curry with Duck & Pineapple",
      "Khao Soi Northern Curry Noodle Soup",
      "Panang Curry Chicken with Kaffir Lime",
      "Pad See Ew Broad Rice Noodles",
      "Crispy Thai Spring Rolls with Sweet Chili",
      "Tom Kha Gai Coconut Chicken Soup",
      "Larb Gai Spicy Ground Chicken Salad",
      "Thai Iced Tea with Condensed Milk",
      "Pineapple Fried Rice in Half Pineapple",
      "Fish Cakes (Tod Mun Pla) with Cucumber Dip",
      "Crying Tiger Grilled Beef Steak",
      "Thai Sweet Banana Pancakes (Roti)",
      "Satay Chicken Skewers with Peanut Sauce",
      "Steamed Whole Seabass with Lime & Garlic",
      "Pad Prik Khing Dry Red Curry Beans",
      "Thai Coconut Pancakes (Khanom Krok)",
      "Mango Passionfruit Shaved Ice",
    ],
    "Chinese": [
      "Kung Pao Chicken with Roasted Peanuts",
      "Steamed Pork & Chive Dumplings (Jiaozi)",
      "Yangzhou Special Fried Rice",
      "Authentic Mapo Tofu with Minced Pork",
      "Crispy Vegetable Chow Mein Noodles",
      "Peking Duck Style Pancakes & Wraps",
      "Classic Sichuan Hot & Sour Soup",
      "Sweet & Sour Crispy Pork (Guo Bao Rou)",
      "Cantonese Dim Sum Shumai Dumplings",
      "Char Siu BBQ Honey Roasted Pork",
      "Dan Dan Noodles with Sesame Chili Paste",
      "Egg Drop Soup with Spring Onions",
      "Xiaolongbao Pork Soup Dumplings",
      "Sizzling Beef & Broccoli Stir-Fry",
      "Hainanese Poached Chicken Rice",
      "Wonton Noodle Soup with Greens",
      "Crispy Spring Rolls with Plum Sauce",
      "General Tso's Crispy Chili Chicken",
      "Mongolian Beef with Scallions",
      "Cantonese Steamed Seabass with Ginger",
      "Sesame Balls with Sweet Red Bean Paste",
      "Mango Sago Coconut Dessert Soup",
      "Hong Kong Style Custard Egg Tarts",
      "Sanbei Ji (Three Cup Chicken)",
    ],
    "Mediterranean": [
      "Greek Village Salad (Horiatiki)",
      "Crispy Falafel Pita Wrap with Tahini",
      "Classic Creamy Hummus & Warm Pita",
      "Shakshuka (Poached Eggs in Tomato Pepper Sauce)",
      "Pan-Seared Mediterranean Seabass",
      "Greek Chicken Souvlaki Skewers",
      "Cool Cucumber Tzatziki Dip",
      "Layered Beef Moussaka Eggplant Bake",
      "Spanakopita Spinach & Feta Pie",
      "Moroccan Lamb Tagine with Prunes & Almonds",
      "Couscous Salad with Roasted Vegetables",
      "Baked Feta with Honey & Fresh Thyme",
      "Stuffed Grape Leaves (Dolmades)",
      "Halloumi Cheese Fries with Mint Yogurt",
      "Lemon Oregano Roasted Potatoes",
      "Mediterranean Grilled Sardines on Toast",
      "Chicken Shawarma Rice Bowl",
      "Tomato Cucumber Za'atar Salad",
      "Sicilian Caponata Eggplant Stew",
      "Calamari Fritti with Lemon Garlic Dip",
      "Pistachio Honey Layered Baklava",
      "Labneh Dip with Olive Oil & Dukkah",
      "Harissa Glazed Roasted Carrots",
      "Turkish Revani Semolina Cake",
    ],
    "French": [
      "Classic French Coq au Vin",
      "Provençal Vegetable Ratatouille",
      "Rich French Onion Soup Gratinee",
      "Savory Quiche Lorraine with Bacon",
      "Sweet French Crepes with Nutella & Strawberry",
      "Classic Croque Monsieur Sandwich",
      "Fluffy Grand Marnier Soufflé",
      "Beef Bourguignon Slow Red Wine Braise",
      "Duck Confit with Crispy Potato Wedges",
      "Bouillabaisse Marseille Seafood Stew",
      "Cassoulet White Bean & Sausage Stew",
      "Salade Niçoise with Fresh Seared Tuna",
      "Sole Meunière with Lemon Parsley Butter",
      "Escargots de Bourgogne with Garlic Herb Butter",
      "Tarte Tatin Caramelized Apple Tart",
      "Profiteroles with Warm Chocolate Ganache",
      "Crème Brûlée with Vanilla Bean Crust",
      "French Baguette with Creamy Brie & Fig Jam",
      "Chicken Chasseur (Hunter's Chicken Stew)",
      "Madeleine Sponge Cakes with Lemon Zest",
      "Macarons Assortment (Raspberry & Dark Chocolate)",
      "Pissaladière Caramelized Onion Tart",
      "Gratin Dauphinois Creamy Scalloped Potatoes",
      "Decadent Dark Chocolate Mousse",
    ],
    "Korean": [
      "Classic Korean Bibimbap Rice Bowl",
      "Spicy Kimchi Stew (Kimchi Jjigae)",
      "Cheesy Tteokbokki Rice Cakes",
      "Extra Crispy Korean Fried Chicken (KFC)",
      "Savory Sweet Beef Bulgogi",
      "Japchae Glass Noodle Stir-Fry",
      "Crispy Seafood Green Onion Pancake (Haemul Pajeon)",
      "Galbi Marinated Grilled Short Ribs",
      "Sundubu Jjigae Soft Tofu Stew",
      "Samgyeopsal Grilled Pork Belly Wraps",
      "Kimbap Korean Rice Roll with Veggies",
      "Cold Naengmyeon Noodle Soup",
      "Bossam Boiled Pork with Bossam Kimchi",
      "Army Stew (Budae Jjigae) with Noodles",
      "Mandu Steamed Korean Pork Dumplings",
      "Hotteok Cinnamon Sweet Street Pancakes",
      "Gamjatang Spicy Pork Bone Stew",
      "Korean Soy Garlic Glazed Wings",
      "Tteokguk Rice Cake New Year Soup",
      "Bingsu Shaved Ice with Sweet Red Beans",
      "Kimchi Fried Rice with Sunny Side Egg",
      "Dakgalbi Spicy Stir-Fried Chicken",
      "Corn Cheese Skillet Appetizer",
      "Ojingeo Bokkeum Spicy Squid Stir-Fry",
    ],
    "Middle Eastern": [
      "Spiced Chicken Shawarma Plate",
      "Saudi Kabsa Spiced Rice with Chicken",
      "Charred Lamb Shish Kebab",
      "Fresh Herb Tabouleh Salad",
      "Smoky Eggplant Baba Ganoush Dip",
      "Lentil Mujadara with Caramelized Onions",
      "Manakeesh Za'atar Flatbread",
      "Fattoush Salad with Crispy Pita Chips",
      "Kibbeh Fried Meat & Bulgur Shells",
      "Mansaf Jordan Rice & Lamb Yoghurt",
      "Knafeh Cheese Dessert with Orange Blossom",
      "Shish Taouk Garlic Marinated Chicken",
      "Egyptian Koshari Rice Noodle Lentil Mix",
      "Mahshi Stuffed Zucchini & Grape Leaves",
      "Foul Mudammas Fava Bean Breakfast Stew",
      "Persian Sabzi Polo Mahi Herb Rice Fish",
      "Arayes Meat Stuffed Grilled Pita",
      "Halva Sesame Confection with Pistachios",
      "Basbousa Semolina Cake with Syrup",
      "Batata Harra Spicy Garlic Potatoes",
      "Yemeni Mandi Smoked Chicken Rice",
      "Kofta Kebab Skewers with Sumac Onions",
      "Muhammara Walnut Red Pepper Dip",
      "Turkish Delight (Lokum) Rosewater Squares",
    ],
    "American comfort": [
      "Double Bacon Smash Cheeseburger",
      "Southern Baked Macaroni & Cheese",
      "Slow-Cooked BBQ Pulled Pork Sandwich",
      "New England Clam Chowder in Sourdough",
      "Crispy Buffalo Chicken Wings",
      "Southern Pecan Pie with Bourbon Cream",
      "Nashville Hot Crispy Fried Chicken",
      "Homestyle Meatloaf with Brown Gravy",
      "Loaded Baked Potato with Sour Cream & Bacon",
      "Texas Smoked Beef Brisket",
      "Golden Fluffy Buttermilk Pancakes",
      "Maryland Crab Cakes with Remoulade",
      "Creamy Chicken & Vegetable Pot Pie",
      "Philly Cheesesteak Sandwich with Peppers",
      "Chicago Deep Dish Cheese Pizza",
      "Classic American Apple Pie",
      "New England Clam Bake Seafood Feast",
      "BBQ Smoked Baby Back Ribs",
      "Cinnamon Roll with Cream Cheese Icing",
      "Grilled Cheese & Roasted Tomato Soup",
      "Key Lime Pie with Whipped Cream",
      "Classic Cobb Salad with Blue Cheese",
      "Sloppy Joe Beef Sandwich",
      "Fudgy Chocolate Brownie Ice Cream Sundae",
    ],
    "Spanish & Iberian": [
      "Seafood Paella Valenciana",
      "Crispy Patatas Bravas with Spicy Sauce",
      "Chilled Spanish Gazpacho Soup",
      "Churros con Chocolate Madrileño",
      ...
      "Croquetas de Jamón Creamy Ham Fritters",
      "Salmorejo Cordobés Creamy Tomato Soup",
      "Bacalao al Pil-Pil Salt Cod in Garlic Oil",
      "Albóndigas Spanish Meatballs in Sauce",
      "Empanadas Gallegas Meat Pie",
      "Calamares en su Tinta Stewed Squid",
      "Fabada Asturiana White Bean Stew",
      "Crema Catalana Caramelized Custard",
      "Pimientos de Padrón Blistered Salt Peppers",
      "Churrasco Flank Steak with Chimichurri",
      "Sangria Fresh Fruit Infused Red Wine",
    ...
    "Vietnamese": [
      "Authentic Beef Pho Noodle Soup (Phở Bò)",
      "Crispy Pork & Pate Bánh Mì Sandwich",
      "Fresh Spring Rolls with Shrimp (Gỏi Cuốn)",
      "Hanoi Grilled Pork & Noodles (Bún Chả)",
      "Crispy Vietnamese Crepe (Bánh Xèo)",
      "Vietnamese Iced Coffee with Condensed Milk",
      "Sizzling Beef Shaking Beef (Bò Lúc Lắc)",
      "Spicy Hue Beef Noodle Soup (Bún Bò Huế)",
      "Turmeric Fish with Fresh Dill (Chả Cả La Vọng)",
      "Crispy Fried Egg Rolls (Chả Giò)",
      "Broken Rice with Grilled Pork Chop (Cơm Tấm)",
      "Vietnamese Chicken Salad (Gỏi Gà)",
      "Lemongrass Chicken Stir-Fry (Gà Xào Sả Ớt)",
      "Caramelized Pork Belly in Claypot (Thịt Kho Tàu)",
      "Steamed Rice Rolls with Pork (Bánh Cuốn)",
      "Crab & Tomato Noodle Soup (Bún Riêu)",
      "Sweet Mung Bean Dessert Balls (Chè Trôi Nước)",
      "Coconut Egg Coffee (Cà Phê Trứng)",
      "Grilled Beef Wrapped in Betel Leaves (Bò Lá Lốt)",
      "Tamarind Seafood Soup (Canh Chua)",
      "Beef Stew with French Baguette (Bò Kho)",
      "Sticky Rice with Mung Bean & Shallots (Xôi Yến)",
      "Mango Coconut Jelly Dessert (Chè Xoài)",
      "Pandan Honey Waffles (Bánh Kẹp Lá Dứa)",
    ],
    "Greek & Aegean": [
      "Greek Moussaka Layered Beef & Eggplant Bake",
      "Spanakopita Spinach & Feta Filo Pie",
      "Souvlaki Chicken Skewers with Tzatziki",
      "Traditional Greek Salad with Feta Block",
      "Gyros Wrap with Seasoned Pork & French Fries",
      "Saganaki Pan-Seared Cheese with Lemon Juice",
      "Keftedes Greek Meatballs with Fresh Herbs",
      "Stuffed Tomatoes & Peppers (Yemista)",
      "Pastitsio Greek Baked Pasta with Béchamel",
      "Gigantes Plaki Baked Giant Tomato Beans",
      "Loukoumades Greek Honey Doughnuts",
      "Tiropita Cheese Triangle Pastries",
      "Kolokithokeftedes Zucchini Fritters",
      "Taramasalata Pink Fish Roe Dip",
      "Octopus Grilled with Oregano & Olive Oil",
      "Galaktoboureko Custard Filo Pie",
      "Kleftiko Slow-Roasted Lamb in Parchment",
      "Fasolada Greek White Bean Soup",
      "Dolmades Rice Stuffed Grape Leaves",
      "Baklava Greek Style with Honey Syrup",
      "Soupa Avgoalemono Egg-Lemon Noodle Soup",
      "Karidopita Walnut Cake with Cinnamon Syrup",
      "Cretan Dakos Barley Rusk Tomato Salad",
      "Halvas Semolina Pudding with Cinnamon",
    ],
    "Turkish & Balkan": [
      "Adana Skewer Spicy Lamb Kebab",
      "Lahmacun Thin Crispy Turkish Pizza",
      "Classic Iskender Kebab with Yogurt & Butter",
      "Turkish Menemen Scrambled Eggs with Tomatoes",
      "Mantı Turkish Mini Meat Dumplings with Yogurt",
      "Simit Sesame Bread Ring",
      "Börek Cheese & Spinach Rolled Pastry",
      "Turkish Stuffed Eggplant (Karnıyarık)",
      "Mercimek Çorbası Red Lentil Soup",
      "Balkan Ćevapi Grilled Meat Fingers with Somun",
      "Pide Flatbread with Minced Meat & Cheese",
      "Turkish Baklava with Antep Pistachios",
      "Künefe Crispy Cheese Dessert with Syrup",
      "Meze Board with Haydari & Hummus",
      "İmam Bayıldı Stuffed Eggplant in Olive Oil",
      "Bosnian Burek Meat Pie",
      "Turkish Coffee with Turkish Delight",
      "Kısır Bulgur Salad with Pomegranate Molasses",
      "Şiş Tavuk Garlic Chicken Skewers",
      "Tavuk Göğsü Milk Pudding Dessert",
      "Serbian Sarma Stuffed Cabbage Rolls",
      "Sutlaç Baked Rice Pudding",
      "Şakşuka Turkish Fried Eggplant Dip",
      "Ezme Spicy Fresh Tomato Salsa",
    ],
    "Caribbean & Latin": [
      "Jamaican Jerk Chicken with Rice & Peas",
      "Puerto Rican Mofongo with Garlic Shrimp",
      "Cuban Ropa Vieja Shredded Beef Stew",
      "Dominican Mangú with Fried Cheese & Salami",
      "Venezuelan Arepas Stuffed with Reina Pepiada",
      "Colombian Bandeja Paisa Feast Plate",
      "Brazilian Feijoada Black Bean & Pork Stew",
      "Peruvian Lomo Saltado Stir-Fry Beef",
      "Peruvian Ceviche with Sweet Potato & Corn",
      "Cuban Sandwich with Roast Pork & Swiss Cheese",
      "Jamaican Beef Patty in Golden Crust",
      "Tostones Fried Green Plantains with Garlic Dip",
      "Arroz con Pollo Latin Chicken & Rice",
      "Brazilian Coxinha Chicken Croquettes",
      "Pabellón Criollo Venezuelan Beef Plate",
      "Lechón Asado Slow Roasted Pork",
      "Sancocho Meat & Root Vegetable Stew",
      "Empanadas de Carne Crispy Meat Pastries",
  ...
  let idCounter = 1;
  const cuisines = Object.keys(cuisineDishCatalog);

  cuisines.forEach((c) => {
    const titlesList = cuisineDishCatalog[c] || [];

    for (let i = 1; i <= 24; i++) {
      const title = titlesList[(i - 1) % titlesList.length] || `${c} Culinary Specialty #${i}`;
      ...
      // Tailor equipment, ingredients, steps, chef tips to dish title
      const tLower = title.toLowerCase();
      let equipment = ["Chef Knife (8-inch)", "Heavy Skillet or Pot", "Cutting Board", "Measuring Spoons"];
      let ingredients = [
        `500g Fresh Main Protein / Vegetable Base`,
        `2 tbsp Fresh ${c} aromatic herbs & regional seasoning`,
      ...
      let chefTip = `Chef's Tip for ${title}: Always bloom spices in warm oil first to unlock deep essential oil aromas!`;

      if (tLower.includes("momo") || tLower.includes("dumpling") || tLower.includes("gyoza") || tLower.includes("jiaozi") || tLower.includes("shumai") || tLower.includes("mandu")) {
        equipment = ["Bamboo Steamer Basket", "Rolling Pin", "Mixing Bowl", "Steamer Cloth"];
        ingredients = [
          "300g Minced Meat or Mushrooms & Finely Chopped Cabbage",
          "1.5 cups All-Purpose Flour & Warm Water (Dough)",
          "1 tbsp Minced Garlic, Ginger & Green Onion",
          "1 tsp Timmur Pepper & Sesame Oil",
          "Spicy Tomato-Sesame Achar Dip",
        ];
        steps = [
          "Mix flour with warm water to form smooth dough; rest for 20 minutes under damp cloth.",
          "Combine minced filling with ginger, garlic, scallions, timmur, and sesame oil.",
          "Roll thin 3-inch wrappers, place 1 tbsp filling, and pleat tightly along edges.",
          "Steam soft in bamboo basket over boiling water for 12 minutes until translucent.",
        ];
        chefTip = "Keep dough wrapped in damp cloth while pleating so wrappers remain soft and pliable!";
      } else if (tLower.includes("ramen") || tLower.includes("pho") || tLower.includes("thukpa") || tLower.includes("soup") || tLower.includes("broth")) {
        equipment = ["Large Stockpot", "Noodle Strainer Basket", "Ladle", "Ceramic Soup Bowls"];
        ingredients = [
          "200g Fresh Noodle Base (Ramen / Rice Noodles)",
          "4 cups Rich Aromatic Broth (Pork, Chicken, or Dashi)",
          "1 Ajitama Soft-Boiled Egg & Chashu Slices",
          "1/2 cup Baby Bok Choy & Wood Ear Mushrooms",
          "Chili Oil & Sliced Green Scallions",
        ];
        steps = [
          "Simmer aromatic broth with ginger, garlic, and soy tare over medium heat for 20 minutes.",
          "Boil fresh noodles in salted water for 2-3 minutes until springy al dente texture.",
          "Ladle piping hot broth into chilled ceramic bowls and slide in drained noodles.",
          "Arrange halved soft-boiled egg, chashu pork, bok choy, and chili oil on top.",
        ];
        chefTip = "Pre-warm your serving bowls with hot tap water so your soup stays piping hot till the last sip!";
      } else if (tLower.includes("pizza") || tLower.includes("calzone") || tLower.includes("lahmacun") || tLower.includes("pide")) {
        equipment = ["Pizza Stone or Cast Iron Pan", "Rolling Pin", "Pizza Peel", "Oven (500°F)"];
        ingredients = [
          "1 Ball Fermented Pizza Dough (72hr fermentation)",
          "1/2 cup San Marzano Tomato Sauce",
          "150g Fresh Mozzarella Cheese",
          "Fresh Basil Leaves & Extra Virgin Olive Oil",
          "Coarse Sea Salt & Chili Flakes",
        ];
        steps = [
          "Preheat oven with pizza stone at maximum heat (500°F) for 45 minutes.",
          "Stretch dough by hand from center outward leaving 1-inch raised cornicione rim.",
          "Ladle light layer of tomato sauce and tear fresh mozzarella over top.",
          "Bake 8-10 minutes until crust is charred and blistered; garnish with fresh basil and olive oil.",
        ];
        chefTip = "Never use a rolling pin on fermented pizza dough—stretching by hand preserves light airy pockets!";
      } else if (tLower.includes("taco") || tLower.includes("burrito") || tLower.includes("quesadilla") || tLower.includes("fajitas") || tLower.includes("shawarma")) {
        equipment = ["Cast Iron Comal or Skillet", "Tongs", "Cutting Board", "Lime Squeezer"];
        ingredients = [
          "6 Warm Double Corn Tortillas or Flatbreads",
          "300g Seared Meat / Mushrooms (Al Pastor, Carne Asada, Chicken)",
          "1/2 cup Diced White Onion & Fresh Cilantro",
          "1/2 cup Roasted Salsa Verde & Pico de Gallo",
          "Fresh Lime Wedges & Crumbled Cotija Cheese",
        ];
        steps = [
          "Marinate meat in citrus juice, cumin, garlic, and chili powder for 30 minutes.",
          "Sear meat over screaming hot cast iron griddle until smoky charred edges form.",
          "Warm corn tortillas on dry griddle until soft and fragrant.",
          "Double stack tortillas, top with seared meat, diced onion, cilantro, and salsa verde.",
        ];
        chefTip = "Char tortillas directly over open gas flame for 5 seconds per side for authentic street cart aroma!";
      } else if (tLower.includes("curry") || tLower.includes("tikka") || tLower.includes("masala") || tLower.includes("biryani") || tLower.includes("tagine")) {
        equipment = ["Heavy Dutch Oven or Kadai", "Wooden Spoon", "Rice Cooker / Pot"];
        ingredients = [
          "500g Main Protein / Vegetables",
          "1 cup Tomato Puree & Greek Yogurt / Cream Base",
          "2 tbsp Garam Masala, Cumin, Coriander & Turmeric",
          "1 tbsp Ghee & Whole Spices (Cardamom, Cloves, Cinnamon)",
          "Fresh Chopped Cilantro & Ginger Matchsticks",
        ];
        steps = [
          "Heat ghee in heavy pot and crackle whole cardamom, cloves, and bay leaf for 30 seconds.",
          "Sauté finely diced onions, garlic, and ginger paste until deep golden brown.",
          "Add ground spices and tomato puree; cook until oil separates from gravy base.",
          "Simmer main ingredients in gravy for 15 minutes; stir in cream and garnish with cilantro.",
        ];
        chefTip = "Always cook the onion-garlic paste until oil separates at the edges—that's when flavors peak!";
      } else if (tLower.includes("cake") || tLower.includes("pie") || tLower.includes("churros") || tLower.includes("tiramisu") || tLower.includes("baklava") || tLower.includes("crepes") || tLower.includes("pancakes")) {
        equipment = ["Mixing Bowls", "Whisk & Spatula", "Baking Sheet or Pan", "Measuring Cups"];
        ingredients = [
          "2 cups Pastry Flour / Oats / Espresso Fingers",
          "1/2 cup Butter or Mascarpone Cheese",
          "1/2 cup Honey / Maple Syrup / Pure Cane Sugar",
          "1 tsp Vanilla Bean Extract & Ground Cinnamon",
          "Toasted Nuts, Cocoa Powder & Fresh Berries",
        ];
        steps = [
          "Whisk liquid and dry ingredients in separate bowls until uniform texture.",
          "Combine gently without overmixing to keep texture tender and airy.",
          "Bake or pan-fry until golden brown and aromatic.",
          "Dust with cocoa powder, powdered sugar, or drizzle with warm honey syrup.",
        ];
        chefTip = "Let baked goods cool for 10 minutes before slicing so moisture seals inside!";
      }

      const image = getDishMatchedImage({
        ...
        ways: 3,
        imageUrl: "",
        nutrition: { calories: `${cal} kcal`, protein: `${prot}g`, carbs: `${carb}g`, fat: `${fat}g`, fiber: `${fib}g` },
        equipment,
        ingredients,
        steps,
        chefTip,
