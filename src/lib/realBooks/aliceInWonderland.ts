...
export function getAliceInWonderlandBook(): ParsedBook {
  const rawText = `
...
`;
  ...
  return parseGutenbergRawText(rawText, {
    ...
    description: "Public domain classic by Lewis Carroll (Catalog #11). Complete chapters with Alice's journey down the rabbit hole.",
    category: "Classics & Fiction",
    rating: 4.8,
    downloadCount: "195K downloads",
  });
}
